...
class OpenStreetMap extends StatefulWidget {
  ...
  @override
  State<OpenStreetMap> createState() => _OpenStreetMapSearchAndPickState();
}

class _OpenStreetMapSearchAndPickState extends State<OpenStreetMap> {
  ...
  Widget build(BuildContext context) {
    ...
    OutlineInputBorder inputFocusBorder = OutlineInputBorder(
        borderSide: BorderSide(color: widget.buttonColor, width: .0),
        borderRadius: const BorderRadius.all(Radius.circular(4.0)));
