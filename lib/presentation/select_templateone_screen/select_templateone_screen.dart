...
class SelectTemplateoneScreen extends StatefulWidget {
  const SelectTemplateoneScreen({ super.key});

                @override
                // ignore: library_private_types_in_public_api
                _SelectTemplateoneScreen createState() => _SelectTemplateoneScreen();
            }

class _SelectTemplateoneScreen extends State<SelectTemplateoneScreen> {
  @override
