...
class ImageModifytwoScreen extends StatefulWidget {
  const ImageModifytwoScreen({ super.key});

                @override
                // ignore: library_private_types_in_public_api
                _ImageModifytwoScreen createState() => _ImageModifytwoScreen();
            }

class _ImageModifytwoScreen extends State<ImageModifytwoScreen> {
  @override
    ...
    return SafeArea(
        ...
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                title: Container(
                    ...
                    child: Stack(children: [
                      ...
                      Padding(
                          padding: getPadding(
                              left: 40, top: 44, right: 115, bottom: 7),
                          child: Row(children: [
                            AppbarIconbutton(
                            ...
                            AppbarTitle(
                                ...
                                margin: getMargin(left: 38, top: 14))
                          ]))
                    ])),
                actions: [
                  AppbarImage(
            ...
            body: Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                          padding:
                              getPadding(left: 5, top: 1, right: 4, bottom: 5),
                          child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Container(
            ...
            bottomNavigationBar: Padding(
                padding: getPadding(left: 62, right: 63, bottom: 40),
                child: Row(
