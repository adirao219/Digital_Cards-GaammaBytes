...
class ImageModifyoneScreen extends StatefulWidget {
  const ImageModifyoneScreen({ super.key});
...
class _ImageModifyoneScreen extends State<ImageModifyoneScreen> {
  @override
                      ...
                      Padding(
                          ...
                          child: Row(children: [
                            ...
                            AppbarTitle(
                                ...
                                margin: getMargin(left: 39, top: 12))
                          ]))
                    ])),
                actions: [
                  AppbarImage(
