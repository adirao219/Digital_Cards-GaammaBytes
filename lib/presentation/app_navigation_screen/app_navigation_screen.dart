...
class AppNavigationScreen extends StatefulWidget {
  ...
  _AppNavigationScreen createState() => _AppNavigationScreen();
}

class _AppNavigationScreen extends State<AppNavigationScreen> {
  @override
  ...
  onTapHomeOnboarding() {
    Navigator.of(context).pushNamed(AppRoutes.homeOnboardingScreen);
  }
  ...
  onTapSearchPopupOne() {
    Navigator.of(context).pushNamed(AppRoutes.searchPopuponeScreen);
  }
  ...
  onTapShare() {
    Navigator.of(context).pushNamed(AppRoutes.shareScreen);
  }
