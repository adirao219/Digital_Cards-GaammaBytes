...
class CardPreviewoneScreen extends StatefulWidget {
  const CardPreviewoneScreen({ super.key});

                @override
                // ignore: library_private_types_in_public_api
                _CardPreviewoneScreen createState() => _CardPreviewoneScreen();
            }

class _CardPreviewoneScreen extends State<CardPreviewoneScreen> {
  @override
