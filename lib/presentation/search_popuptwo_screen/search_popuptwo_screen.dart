...
import 'package:digitalcards_gaammabytes/presentation/search_popuptwo_screen/widgets/gridbusinesscardseven2_item_widget.dart';

import '../search_popuptwo_screen/widgets/listlanguage_three1_item_widget.dart';
...
import 'models/search_popuptwo_model.dart';

class SearchPopuptwoScreen extends StatefulWidget {
  const SearchPopuptwoScreen({ super.key});

                @override
                // ignore: library_private_types_in_public_api
                _SearchPopuptwoScreen createState() => _SearchPopuptwoScreen();
            }

class _SearchPopuptwoScreen extends State<SearchPopuptwoScreen> {
  
    Rx<SearchPopuptwoModel> searchPopuptwoModelObj =
      SearchPopuptwoModel().obs;
  @override
                                              ...
                                              child: Padding(
                                                  ...
                                                  child: Obx(() =>
                                                      ListView.separated(
                                                          ...
                                                          itemCount:searchPopuptwoModelObj
                                                              .value
                                                              .listlanguageThree1ItemList
                                                              .length,
                                                          itemBuilder:
                                                              (context, index) {
                                                            ListlanguageThree1ItemModel
                                                                model =
                                                                searchPopuptwoModelObj
                                                                    .value
                                                                    .listlanguageThree1ItemList[index];
                                                            return ListlanguageThree1ItemWidget(
                                                                model);
                                                          })))),
                                          Align(
                                              alignment: Alignment.center,
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        Obx(() => GridView.builder(
                                            ...
                                            itemCount: searchPopuptwoModelObj
                                                .value
                                                .gridbusinesscardseven2ItemList
                                                .length,
                                            itemBuilder: (context, index) {
                                              Gridbusinesscardseven2ItemModel
                                                  model = searchPopuptwoModelObj
                                                          .value
                                                          .gridbusinesscardseven2ItemList[
                                                      index];
                                              return Gridbusinesscardseven2ItemWidget(
                                                  model);
                                            })),
                                        Padding(
