class GetGetCreateCardResp {
  bool? isSuccess;
  GetCardResult? result;
  dynamic errorMessage;

  GetGetCreateCardResp({this.isSuccess, this.result, this.errorMessage});

  GetGetCreateCardResp.fromJson(Map<String, dynamic> json) {
    isSuccess = json['IsSuccess'];
    result =
        json['Result'] != null ? GetCardResult.fromJson(json['Result']) : null;
...
class GetCardResult {
  ...
  List<LogoPositionList>? logoPositionList;
  dynamic contentPosition;
  dynamic contentPositionName;
  List<ContentPositionList>? contentPositionList;
  int? creditId;
  int? cardStatus;
  ...
  int? backgroundType;
  int? sliceNum;
  dynamic backgroundHeader;
  dynamic backgroundHeaderRef;
  dynamic backgroundHeaderOldId;
  dynamic backgroundFooter;
  dynamic backgroundFooterRef;
  dynamic backgroundFooterOldId;
  bool? mirrorHeaderImage;
  dynamic marginTop;
  ...
  GetCardResult({
    ...
    this.backgroundHeaderRef,
    this.backgroundHeaderOldId,
    this.backgroundFooter,
    this.backgroundFooterRef,
    this.backgroundFooterOldId,
    this.mirrorHeaderImage,
    this.marginTop,
    this.marginBottom,
    this.marginLeft,
    this.marginRight,
  ...
  GetCardResult.fromJson(Map<String, dynamic> json) {
    ...
    if (json['LogoPositionList'] != null) {
      logoPositionList = <LogoPositionList>[];
      json['LogoPositionList'].forEach((v) {
        logoPositionList?.add(LogoPositionList.fromJson(v));
      });
    }
    contentPosition = json['ContentPosition'];
    contentPositionName = json['ContentPositionName'];
    if (json['ContentPositionList'] != null) {
      contentPositionList = <ContentPositionList>[];
      json['ContentPositionList'].forEach((v) {
        contentPositionList?.add(ContentPositionList.fromJson(v));
      });
    }
    ...
    sliceNum = json['SliceNum'];
    backgroundHeader = json['BackgroundHeader'];
    backgroundHeaderRef = json['BackgroundHeaderRef'];
    backgroundHeaderOldId = json['BackgroundHeaderOldId'];
    backgroundFooter = json['BackgroundFooter'];
    backgroundFooterRef = json['BackgroundFooterRef'];
    backgroundFooterOldId = json['BackgroundFooterOldId'];
    mirrorHeaderImage = json['MirrorHeaderImage'];
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.logoPositionList != null) {
      data['LogoPositionList'] =
          this.logoPositionList?.map((v) => v.toJson()).toList();
    }
    ...
    if (this.contentPositionList != null) {
      data['ContentPositionList'] =
          this.contentPositionList?.map((v) => v.toJson()).toList();
    }
...
class LogoPositionList {
  ...
  LogoPositionList.fromJson(Map<String, dynamic> json) {
    disabled = json['Disabled'];
    group = json['Group'];
    selected = json['Selected'];
    text = json['Text'];
...
class ContentPositionList {
  ...
  ContentPositionList.fromJson(Map<String, dynamic> json) {
    disabled = json['Disabled'];
    group = json['Group'];
    selected = json['Selected'];
    text = json['Text'];
...
enum UserImageType{
  ...
  const UserImageType(this.value);
  final int value;
}