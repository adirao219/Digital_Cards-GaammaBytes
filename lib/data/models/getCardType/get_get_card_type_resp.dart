class GetGetCardTypeResp {
  bool? isSuccess;
  List<DigitalCardTypeResult>? result;
  dynamic errorMessage;

  GetGetCardTypeResp({this.isSuccess, this.result, this.errorMessage});

  GetGetCardTypeResp.fromJson(Map<String, dynamic> json) {
    isSuccess = json['IsSuccess'];
    if (json['Result'] != null) {
      result = <DigitalCardTypeResult>[];
      json['Result'].forEach((v) {
        result?.add(DigitalCardTypeResult.fromJson(v));
      });
    }
...
class DigitalCardTypeResult {
  ...
  DigitalCardTypeResult.fromJson(Map<String, dynamic> json) {
    id = json['ID'];
