...
class AppDecoration {
  ...
  static BoxDecoration get outlineWhiteA700 => BoxDecoration(
        color: ColorConstant.cyanA2002d,
        border: Border.all(
  ...
  static BoxDecoration get fillRed10001 => BoxDecoration(
        color: ColorConstant.red10001,
      );
  static BoxDecoration get outlinePink9001 => BoxDecoration(
        color: ColorConstant.whiteA700,
      );
  static BoxDecoration get outlineWhiteA7001 => BoxDecoration(
        color: ColorConstant.purpleA2002d,
        border: Border.all(
          color: ColorConstant.whiteA700,
          width: getHorizontalSize(
            2.00,
  ...
  static BoxDecoration get fillDeeporangeA100a3 => BoxDecoration(
        color: ColorConstant.deepOrangeA100A3,
      );
  ...
  static BoxDecoration get fillDeeporange60033 => BoxDecoration(
        color: ColorConstant.deepOrange60033,
      );
